...
$FindBuilding = $connecDB->query("SELECT * FROM Buildings WHERE HotelID = '".$_SESSION['HotelID']."' AND ID = $BuildingID LIMIT 1");
if(mysqli_num_rows($FindBuilding) > 0){
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="name" id="name" data-required="1" required="required" value="<?php echo $Name; ?>" class="form-control input-height" /> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="col-md-12">
                                                       <textarea name="description" id="description" class="form-control-textarea" rows="5"><?php echo $Description; ?></textarea>
                                                    </div>
                                                </div> 
                                            ...
                                            <div class="col-md-6 col-sm-12">  
                                                    <div class="form-body"> 
                                                        ...
                                                        <form action="/php/upload.php?type=building&ID=<?php echo $ID; ?>" METHOD="POST" enctype="multipart/form-data" class="dropzone"> 
                                                        </form> 
                                                    </div>
                                                <form action="/php/upload.php?type=building&ID=<?php echo $ID; ?>" METHOD="POST" enctype="multipart/form-data" class="dropzone"> 
                                                </form>
                <?php 
                $FindImg = $connecDB->query("SELECT * FROM Images WHERE HotelID = '".$_SESSION['HotelID']."'AND TableName = 'building' AND TableRow = '$ID' AND Active = 'y'");
                if(mysqli_num_rows($FindImg) > 0){
                    while($rowb = $FindImg->fetch_array()){ ?>
                                                            <div class="col-md-4 uploaded-image" style="background-image: url('\\uploads\\<?php echo $rowb['FileName']; ?>'); margin-top: 15px; ">
                                                                <div class="hover-me">
                ...
                ?>      
                                             ...
                                             <div class="col-md-12" style="text-align: center; padding-top: 15px;">
                                                    <a href="/view-buildings.php">
                                                        <button id="submit" class="btn btn-info m-r-20">Done</button> 
                                                    </a>
                                                </div>
                                        </div>
                                        </div>
        ...
        frm.submit(function (e) {
            ...
            if (postVar < 1) {
                $.post('hotel-editor/edit-hotel.php',{'website':website,'phone':phone,'email':email,'address':address}, function(result) { 
                    ...
                    if(result == 'Success'){
                        //$('#echo-result').html(result);
                        swal("Success", "The building has been updated.", "success");
                    }else{
                        $('#echo-result').html(result);  
                    }
                });   
